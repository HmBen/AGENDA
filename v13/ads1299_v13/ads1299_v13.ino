...
*/
  ...
  ADS.WREG(0x05, GAIN_1x | CHSET_INPUT); // CH01SET
  ADS.WREG(0x06, GAIN_1x | CHSET_INPUT); // CH02SET
  ADS.WREG(0x07, GAIN_1x | CHSET_INPUT); // CH03SET
  ADS.WREG(0x08, GAIN_1x | CHSET_INPUT); // CH04SET
  ADS.WREG(0x09, GAIN_1x | CHSET_INPUT); // CH05SET
  ADS.WREG(0x0A, GAIN_1x | CHSET_INPUT); // CH06SET
  ADS.WREG(0x0B, GAIN_1x | CHSET_INPUT); // CH07SET
  ADS.WREG(0x0C, GAIN_1x | CHSET_INPUT); // CH08SET

  ADS2.WREG(0x05, GAIN_1x | CHSET_INPUT); // CH09SET
  ADS2.WREG(0x06, GAIN_1x | CHSET_INPUT); // CH10SET
  ADS2.WREG(0x07, GAIN_1x | CHSET_INPUT); // CH11SET
  ADS2.WREG(0x08, GAIN_1x | CHSET_INPUT); // CH12SET
  ADS2.WREG(0x09, GAIN_1x | CHSET_INPUT); // CH13SET
  ADS2.WREG(0x0A, GAIN_1x | CHSET_INPUT); // CH14SET
  ADS2.WREG(0x0B, GAIN_1x | CHSET_INPUT); // CH15SET
  ADS2.WREG(0x0C, GAIN_1x | CHSET_INPUT); // CH16SET
